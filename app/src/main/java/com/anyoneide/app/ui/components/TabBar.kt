                    ...
                    DropdownMenuItem(
                        text = {
                            Row(verticalAlignment = Alignment.CenterVertically) {
                                ...
                                Text("File", fontWeight = androidx.compose.ui.text.font.FontWeight.Bold)
                            }
                        },
                        onClick = { },
                        enabled = false
                    ...
                    DropdownMenuItem(
                        text = {
                            Row(verticalAlignment = Alignment.CenterVertically) {
                                ...
                                Spacer(Modifier.width(8.dp))
                                Text("Editor", fontWeight = androidx.compose.ui.text.font.FontWeight.Bold)
                            }
                        },
                        onClick = { },
                        enabled = false
                    ...
                    DropdownMenuItem(
                        text = {
                            Row(verticalAlignment = Alignment.CenterVertically) {
                                ...
                                Spacer(Modifier.width(8.dp))
                                Text("Project Templates", fontWeight = androidx.compose.ui.text.font.FontWeight.Bold)
                            }
                        },
                        onClick = { },
                        enabled = false
                    ...
                    DropdownMenuItem(
                        text = {
                            Row(verticalAlignment = Alignment.CenterVertically) {
                                ...
                                Spacer(Modifier.width(8.dp))
                                Text("Tools", fontWeight = androidx.compose.ui.text.font.FontWeight.Bold)
                            }
                        },
                        onClick = { },
                        enabled = false
